(() => {
  ...
  const translations = {
    es: {
      ...
      "nav-cta": "Presupuesto",
      "hero-tagline": "¿Buscas un bot a medida? Estoy disponible",
      "hero-description": "Transformo tus ideas en <strong>bots de Discord escalables</strong> y sistemas <strong>backend robustos</strong>. Con más de 5 años de experiencia y proyectos que alcanzan a miles de usuarios, estoy aquí para llevar tu proyecto al siguiente nivel.",
      "hero-btn-projects": "Ver trabajos",
      "hero-btn-hire": "Contáctame ahora",
      ...
      "service-bots-title": "Bots de Discord",
      "service-bots-desc": "Sistemas de moderación, economía y herramientas únicas para tu comunidad.",
      "service-backend-title": "Backend & APIs",
      "service-backend-desc": "Infraestructura sólida y escalable en Java para cualquier aplicación.",
      "service-consulting-title": "Consultoría",
      "service-consulting-desc": "¿No sabes por dónde empezar? Te ayudo a diseñar la mejor solución.",
      ...
      "contact-instruction": "Rellena el formulario y me pondré en contacto contigo para darte presupuesto.",
      "footer-made": "Hecho con <em>café</em> y Java ☕",
      "phrases": [
        'Desarrollador de Bots de Discord',
        'Experto en Backend Java',
        'Soluciones a medida',
    ...
    en: {
      ...
      "nav-contact": "Contact",
      "nav-cta": "Get a Quote",
      "hero-tagline": "Looking for a custom bot? I'm available",
      "hero-description": "I transform your ideas into <strong>scalable Discord bots</strong> and <strong>robust backend</strong> systems. With over 5 years of experience and projects reaching thousands of users, I'm here to take your project to the next level.",
      "hero-btn-projects": "View work",
      "hero-btn-hire": "Contact me now",
      ...
      "service-bots-title": "Discord Bots",
      "service-bots-desc": "Moderation systems, economy, and unique tools for your community.",
      "service-backend-title": "Backend & APIs",
      "service-backend-desc": "Solid and scalable Java infrastructure for any application.",
      "service-consulting-title": "Consulting",
      "service-consulting-desc": "Don't know where to start? I'll help you design the best solution.",
      ...
      "contact-instruction": "Fill out the form and I will get back to you with a quote.",
