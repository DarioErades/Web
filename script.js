(() => {
  ...
  const translations = {
    es: {
      ...
      "hero-description": "Construyendo software robusto en <strong>Java</strong> desde hace <strong>5 años</strong>. Estudiante de Ingeniería Informática, creador de bots usados por más de <strong>25.000 personas</strong> y colaborador con creadores de contenido de más de <strong>400.000 suscriptores</strong>.",
      ...
      "exp-desc-1": "Empecé como desarrollador principal del Discord de <strong>KPI</strong>, una comunidad de más de 25.000 miembros. Arquitectura y mantenimiento de un bot completo con base de datos, panel web, sistema de niveles, moderación, economía y analítica en tiempo real.",
      ...
      "exp-role-3": "Desarrollador principal · Canales +400K subs",
      "exp-desc-3": "Desarrollador principal para canales de YouTube con audiencias de más de 400.000 suscriptores: bots a medida, herramientas internas, integraciones con APIs externas y dashboards privados usados a diario por sus equipos.",
      ...
      "projects-tag": "04 — Trabajos",
      "projects-title": "Proyectos <span class=\"gradient-text\">destacados.</span>",
      "project-desc-1": "Bot completo desarrollado para el Discord de KPI (+25.000 miembros). Incluye base de datos robusta, panel web de administración, sistema de niveles, moderación automática, economía, analítica en tiempo real e integraciones con APIs externas. Funcionando 24/7.",
    ...
    en: {
      ...
      "hero-description": "Building robust software in <strong>Java</strong> for <strong>5 years</strong>. Computer Engineering student, creator of bots used by more than <strong>25,000 people</strong> and collaborator with content creators with more than <strong>400,000 subscribers</strong>.",
      ...
      "exp-desc-1": "Started as lead developer for <strong>KPI</strong> Discord, a community of over 25,000 members. Architecture and maintenance of a complete bot with database, web panel, level system, moderation, economy and real-time analytics.",
      ...
      "exp-role-3": "Lead Developer · Channels +400K subs",
      "exp-desc-3": "Lead developer for YouTube channels with audiences of over 400,000 subscribers: custom bots, internal tools, integrations with external APIs and private dashboards used daily by their teams.",
      ...
      "projects-tag": "04 — Works",
      "projects-title": "Featured <span class=\"gradient-text\">projects.</span>",
      "project-desc-1": "Complete bot developed for KPI Discord (+25,000 members). Includes robust database, web administration panel, level system, automatic moderation, economy, real-time analytics and integrations with external APIs. Running 24/7.",
